...
context_writes:
- brand/{slug}/go-to-market/metrics-plan/current.md
...
Leer `company-brief/current.md`. Inferir arquetipo:
...
### 1. Metrics Plan Document → `brand/{slug}/go-to-market/metrics-plan/current.md`
