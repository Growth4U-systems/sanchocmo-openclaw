...
- Link: build with the MC URL format from `workspace-sancho/PROTOCOLS.md` Rule 3 (the host is already pre-resolved in that document). Path: `/portal/{mcToken}/docs/brand/{slug}/visual-identity/current.md`
