...
- Read `brand/{slug}/market-and-us/competitors/current.md` for competitor list
- For each competitor, read individual battle card for URLs and social profiles
- Read `brand/{slug}/brand-book/brand-voice/current.md` and ECPs for adaptation context
