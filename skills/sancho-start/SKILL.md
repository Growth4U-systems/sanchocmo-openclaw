...
```
if brand/{slug}/company-brief/current.md exists AND is complete:
    mode = "RETURNING"
...
1. **Escribir `brand/{slug}/company-brief/current.md`** con los datos estructurados del onboarding
...
He guardado tu contexto en brand/{slug}/company-brief/current.md.
...
- `brand/{slug}/company-brief/current.md` (generado en Step 8)
