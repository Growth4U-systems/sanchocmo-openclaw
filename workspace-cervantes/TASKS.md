...
| T-050 | Reestructurar Memory Stack — 3 fases (core, durabilidad, inteligencia) | `[flow]` | P2 | Cervantes 2026-03-15 | Auditar MEMORY.md vs framework 3 fases. Separar: operativa (heartbeats), cliente (brand/), aprendizaje (mejora continua). Fuente: bibliografía "Comprehensive Memory Stack for Agent Intelligence". Thread Discord: 1482643082393419969. |
...
| T-052 | Arquitectura Agentes Narrow — single metric por agente | `[agent]` | P3 | Cervantes 2026-03-15 | Auditar 4 agentes. ¿Sancho hace demasiado? Definir 1 métrica/agente. Evaluar agentes por cliente o canal. Fuente: bibliografía "Narrow Focus" + "Karpathy Autoresearch". Thread Discord: 1482643246827176077. |
