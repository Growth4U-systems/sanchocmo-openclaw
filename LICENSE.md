...
provide it to others only if you do so free of charge for the recipient and for
non-commercial or internal business purposes, and only if the recipient agrees
to this license.

You may not provide the software to third parties as a hosted or managed
service, where the service provides users with access to any substantial set of
the features or functionality of the software, whether such access is granted
...
The **licensor** is Growth4U Systems, the entity offering these terms, and the
...
> license. It is adapted from the n8n Sustainable Use License. All rights not
> expressly granted above are reserved by Growth4U Systems. Legal review is
