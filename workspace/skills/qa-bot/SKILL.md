...
name: qa-bot
description: >
  Quality assurance bot for content review. Checks brand voice compliance, messaging consistency, SEO optimization. Use for 'review this', 'check quality', 'QA this content'.
metadata:
