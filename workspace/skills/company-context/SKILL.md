...
description: >
  Captures the foundational context about a client's company: what they do, what
  they want, and what they believe. Always-first pillar (Layer 0) — no dependencies.
  Use when onboarding a new client, when foundation-orchestrator routes here, when
  user says "tell me about the company", "update company context", or "company
  profile". Also triggers when company-context status is empty or incomplete in the
  Context Lake. Do NOT use for competitor analysis (use competitor-intelligence),
  market research (use market-intelligence), or team/resource inventory (handled
  inline by foundation-orchestrator).
metadata:
