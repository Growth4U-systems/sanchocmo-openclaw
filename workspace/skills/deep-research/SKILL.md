...
name: deep-research
description: >
  Multi-source deep research with structured analysis and QA verification. Produces sourced reports with executive summaries. Use for 'deep research', 'market analysis', 'benchmark'. Not for quick lookups.
metadata:
