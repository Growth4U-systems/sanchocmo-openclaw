...
description: "Analyzes the total market via Google Gemini Deep Research: TAM (total addressable market), available segments, market maturity, regulatory landscape with marketing restrictions, competitive overview, customer personas, and trends with time horizons. Foundation pillar (Layer 2), depends on company-context. Produces 15-25 page report. Feeds TAM and context to niche-discovery (which then calculates SAM/SOM per ECP). Use when foundation-orchestrator routes here, when user says market analysis, market size, TAM, regulatory landscape, market trends, industry analysis, sector overview, market maturity, or Gemini market research. Do NOT use for SAM/SOM calculation (use niche-discovery-100x), competitor battle cards (use competitor-intelligence), or general web research (use deep-research)."
metadata:
  ...
  updated: "2026-02-19"
  changes: "Removed SAM/SOM (moved to niche-discovery), added Gemini Deep Research automation, TAM-only focus"
---
