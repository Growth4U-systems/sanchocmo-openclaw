...
description: ROBAR IDEAS de competidores analizando Facebook Ads, calendarios sociales, feature changelogs, y landing pages. Input son Battle Cards de competitor-intelligence. Scrape plataformas públicas (FB Ads Library, LinkedIn, Twitter, Product Hunt), extrae patterns (hooks, creative themes, CTAs, content pillars, posting cadence), genera Content Ideas DB adaptadas a tu brand. Fase Encuentra del flujo SanchoCMO (one-to-many). Use cuando necesitas ideas de contenido basadas en qué funciona para competidores, cuando competitor-intelligence está completo, o cuando usuario dice roba ideas de competidores, analiza ads de Competidor, qué contenido publica Competidor, steal competitor ideas, thief marketers, copy competitor strategy. Do NOT use para análisis competitivo básico (usar competitor-intelligence) ni para copiar landing page copy (usar direct-response-copy). Esta skill es para IDEA GENERATION, no execution.
metadata:
