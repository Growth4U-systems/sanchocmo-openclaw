...
description: Convierte insights (de daily-pulse, meetings, o input manual) en content briefs completos SEO-optimized. Expande insight a tema, ejecuta keyword research con WebSearch, analiza top-ranking content, selecciona angulo diferenciado desde positioning.md, genera brief completo (keyword, outline H2/H3, PAA questions, word count, CTAs, internal links). Output listo para seo-content skill o escritor humano. Fase Encuentra->Decide bridge SanchoCMO. Use cuando tienes insights y necesitas briefs, despues de daily-pulse, o usuario dice create content brief, turn this insight into content, brief this topic, make a content plan from insights. Do NOT use para escribir el contenido final (usar seo-content) ni para keyword research puro (usar keyword-research).
metadata:
