...
description: Encuentra decision makers (personas) dentro de empresas target de company-finder. Busca por rol (CEO, VP, Director, Manager), valida perfiles LinkedIn (foto, actividad, conexiones), aplica relevance scoring, prioriza por decision-making power y engagement level. Output decision-makers-YYYYMMDD.json con 1-3 contactos por empresa. Usa LinkedIn Sales Navigator, Apollo, o Apify actors. Fase Encuentra SanchoCMO (one-to-one). Use cuando tienes lista de empresas y necesitas encontrar a quien contactar, despues de company-finder, o usuario dice find decision makers, who should I contact at Company, busca el responsable de marketing, find the VP of Sales, quien decide en esta empresa. Do NOT use para encontrar empresas (usar company-finder) ni para conseguir emails (usar contact-enrichment).
metadata:
