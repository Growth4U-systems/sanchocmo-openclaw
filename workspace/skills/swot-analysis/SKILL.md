---
name: swot-analysis
description: "Builds a SWOT analysis from actual intelligence (not assumptions) and derives cross-strategies using the TOWS Matrix (Heinz Weihrich). Strengths/Weaknesses from self-intelligence, Opportunities/Threats from competitor-intelligence + market-intelligence. Foundation pillar (Layer 3), depends on self-intelligence + competitor-intelligence + market-intelligence. Produces 4-quadrant SWOT + TOWS matrix with SO/ST/WO/WT strategies + prioritized strategic actions. Use when foundation-orchestrator routes here, when user says SWOT, strategic analysis, TOWS, strengths and weaknesses, opportunities and threats, strategic fit, or what are our advantages. Also triggers when swot status is empty in Context Lake. Do NOT use for competitor research (use competitor-intelligence), market sizing (use market-intelligence), or positioning (use positioning-messaging)."
metadata:
  ...
  updated: "2026-02-19"
  changes: "Automated with CoT prompt (Alfonso's production version), ICE prioritization, consulting-grade output"
---
