...
const i18n = {
  es: {
    ...
    agents: [
      ...
      { name: "Rocinante", ch: "#prospecting, #partners", model: "Sonnet 4.5", role: "Outreach, Partnerships & GTM-OS", emoji: "🐴" },
      { name: "Maese Pedro", ch: "#creatives, #design, #web", model: "Opus 4.6", role: "Visual Director / Creative Engine", emoji: "🎭" },
      { name: "Alarife", ch: "#web", model: "Sonnet 4.5", role: "Web/Page Builder", emoji: "🧱" },
    ...
    faq: [
      ...
      { q: "¿Los datos de un cliente se mezclan con otro?", a: "No. Cada cliente tiene su propio servidor Discord y directorio brand/, con datos aislados en la base de datos. Zero data leakage. Solo las skills y agentes se comparten (vía symlinks)." },
      { q: "¿Cuánto cuesta operar?", a: "APIs de IA (Anthropic ~$20-100/mes según uso), base de datos PostgreSQL (Postgres local incluido, o Neon con free tier generoso), Tailscale (free para equipos pequeños). No hay fee del sistema." },
    ...
    accessInternalContent: '1. Instalar Tailscale<br />2. Unirse a la Tailnet<br />3. <code class="text-[10px]">https://your-instance.ts.net</code><br />4. Discord: todos los canales',
  ...
  en: {
    ...
    faq: [
      ...
      { q: "Does one client's data mix with another?", a: "No. Each client has their own Discord server and brand/ directory, with isolated data in the database. Zero data leakage. Only skills and agents are shared (via symlinks)." },
      { q: "How much does it cost to operate?", a: "AI APIs (Anthropic ~$20-100/month depending on usage), PostgreSQL database (local Postgres bundled, or Neon with a generous free tier), Tailscale (free for small teams). No system fee." },
    ...
    accessInternalContent: '1. Install Tailscale<br />2. Join the Tailnet<br />3. <code class="text-[10px]">https://your-instance.ts.net</code><br />4. Discord: all channels',
