...
> = {
  ...
  fireworks: [
    { key: "FIREWORKS_API_KEY", label: "API Key", placeholder: "fw-..." },
    {
      key: "FIREWORKS_ACCOUNT_ID",
      label: "Account ID",
      placeholder: "accounts/...",
      help: "Necesario para leer billingUsage y calcular consumo/coste real por modelo.",
    },
    {
      key: "LLM_USAGE_USD_TO_EUR",
      label: "Tipo USD→EUR tracker",
      placeholder: "0.92",
      help: "Fireworks factura en USD; Sancho muestra el tracker diario en EUR usando este tipo.",
    },
  ],
  ...
  scrapecreators: [
    {
      ...
      label: "API Key",
      placeholder: "scrapecreators...",
      help: "Necesaria para discovery real de creators. Sancho la usa contra https://api.scrapecreators.com.",
    },
    {
      key: "SCRAPECREATORS_TIMEOUT_MS",
      label: "Timeout por petición (ms)",
      placeholder: "30000",
      help: "Tiempo máximo de cada petición individual a ScrapeCreators.",
    },
    {
      key: "PARTNERSHIPS_LIVE_DISCOVERY_TIMEOUT_MS",
      label: "Timeout total discovery (ms)",
      placeholder: "300000",
      help: "Deadline global del runner live. Por defecto: 5 minutos.",
    },
    {
      key: "PARTNERSHIPS_LIVE_DISCOVERY_MAX_CANDIDATES",
      label: "Máximo operativo",
      placeholder: "500",
      help: "Tope de seguridad. El volumen real lo determina targetVolume del plan.",
    },
    {
      key: "PARTNERSHIPS_LIVE_DISCOVERY_CONCURRENCY",
      label: "Concurrencia",
      placeholder: "5",
      help: "Perfiles enriquecidos en paralelo.",
    },
  ],
  ...
  slack: [
    ...
    {
      key: "LLM_USAGE_SLACK_BOT_TOKEN",
      label: "Bot Token reporte costes",
      placeholder: "xoxb-...",
      help: "Token dedicado del bot que enviara el reporte diario. Si falta, Sancho puede usar SLACK_BOT_TOKEN como fallback.",
    },
    {
      key: "LLM_USAGE_SLACK_EXPECTED_BOT",
      label: "Bot esperado reporte costes",
      placeholder: "SanchoCMO",
      help: "Nombre que debe devolver Slack auth.test para el token del reporte. Por defecto: SanchoCMO.",
    },
    {
      key: "LLM_USAGE_SLACK_ALLOW_DEFAULT_TOKEN",
      label: "Fallback token Slack",
      placeholder: "1",
      help: "1 permite usar SLACK_BOT_TOKEN si falta el token dedicado del reporte; 0 exige LLM_USAGE_SLACK_BOT_TOKEN.",
    },
    {
      key: "LLM_USAGE_SLACK_REQUIRE_BILLING",
      label: "Exigir billing proveedor",
      placeholder: "0",
      help: "0 envia el reporte con aviso si el billing del proveedor no esta listo; 1 bloquea el envio hasta tener billing.",
    },
  ],
  "runtime-external": [
    {
      ...
      label: "Protocol",
      placeholder: "sancho",
      help: "sancho usa POST /sancho/inbound asincrónico. mc-bridge usa POST /chat y guarda la respuesta síncrona.",
    },
    {
      key: "SANCHO_EXTERNAL_GATEWAY_URL",
      label: "Gateway URL",
      placeholder: "https://runtime.example.com",
      help: "Endpoint HTTP de un runtime compatible con Sancho. Por defecto Sancho llama a /sancho/inbound.",
    },
    {
      key: "SANCHO_EXTERNAL_SECRET",
      label: "Shared secret",
      placeholder: "secret compartido",
      help: "Se manda como X-MC-Secret al runtime externo. No reutilices MC_CHAT_SECRET para endpoints de terceros.",
    },
    {
      key: "SANCHO_EXTERNAL_INBOUND_PATH",
      label: "Inbound path",
      placeholder: "/sancho/inbound",
      help: "Opcional. Cambialo solo si el gateway externo usa otra ruta.",
    },
    {
      key: "SANCHO_EXTERNAL_CHAT_PATH",
      label: "Bridge chat path",
      placeholder: "/chat",
      help: "Opcional para SANCHO_EXTERNAL_PROTOCOL=mc-bridge. Ruta del endpoint de chat síncrono.",
    },
    {
      key: "SANCHO_EXTERNAL_HEALTH_PATH",
      label: "Health path",
      placeholder: "/healthz",
      help: "Opcional. Ruta usada por el botón de verificación.",
    },
    {
      key: "SANCHO_EXTERNAL_AGENT",
      label: "Bridge agent/profile",
      placeholder: "sancho-coordinator",
      help: "Opcional para mc-bridge. Perfil/agent que recibirá los mensajes dentro del bridge.",
    },
    {
      key: "HERMES_EXTERNAL_GATEWAY_URL",
      label: "Legacy Hermes gateway URL",
      placeholder: "https://hermes.example.com",
      help: "Alias legacy. Preferí SANCHO_EXTERNAL_GATEWAY_URL para instalaciones nuevas.",
    },
    {
      key: "HERMES_EXTERNAL_SECRET",
      label: "Legacy Hermes shared secret",
      placeholder: "secret compartido",
      help: "Alias legacy. Preferí SANCHO_EXTERNAL_SECRET para instalaciones nuevas.",
    },
    {
      key: "HERMES_EXTERNAL_INBOUND_PATH",
      label: "Legacy Hermes inbound path",
      placeholder: "/sancho/inbound",
      help: "Alias legacy.",
    },
    {
      key: "HERMES_EXTERNAL_HEALTH_PATH",
      label: "Legacy Hermes health path",
      placeholder: "/healthz",
      help: "Alias legacy.",
    },
    {
      key: "HERMES_EXTERNAL_PROTOCOL",
      label: "Legacy Hermes protocol",
      placeholder: "sancho",
      help: "Alias legacy.",
    },
  ],
  "hermes-external": [
    {
      ...
      label: "Gateway URL",
      placeholder: "https://hermes.example.com",
      help: "Endpoint HTTP del Hermes propio. Sancho llama a /sancho/inbound por defecto.",
    },
    {
      key: "HERMES_EXTERNAL_SECRET",
      label: "Shared secret",
      placeholder: "secret compartido",
      help: "Se manda como X-MC-Secret al Hermes externo. No reutilices MC_CHAT_SECRET para endpoints de terceros.",
    },
    {
      key: "HERMES_EXTERNAL_INBOUND_PATH",
      label: "Inbound path",
