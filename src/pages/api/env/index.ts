...
> = {
  ...
  "runtime-external": [
    ...
    },
    {
      ...
      label: "Protocol",
      placeholder: "sancho",
      help: "sancho usa POST /sancho/inbound asincronico. mc-bridge usa POST /chat y guarda la respuesta sincrona.",
    },
    {
    ...
    },
    {
      ...
      placeholder: "/chat",
      help: "Opcional para SANCHO_EXTERNAL_PROTOCOL=mc-bridge. Ruta del endpoint de chat sincrono.",
    },
    {
      key: "SANCHO_EXTERNAL_HEALTH_PATH",
      label: "Health path",
      placeholder: "/healthz",
      help: "Opcional. Ruta usada por el boton de verificacion.",
    },
    {
      key: "SANCHO_EXTERNAL_AGENT",
      label: "Bridge agent/profile",
      placeholder: "sancho-coordinator",
      help: "Opcional para mc-bridge. Perfil/agent que recibira los mensajes dentro del bridge.",
    },
    {
      key: "HERMES_EXTERNAL_GATEWAY_URL",
      label: "Legacy Hermes gateway URL",
      placeholder: "https://hermes.example.com",
      help: "Alias legacy. Preferi SANCHO_EXTERNAL_GATEWAY_URL para instalaciones nuevas.",
    },
    {
      key: "HERMES_EXTERNAL_SECRET",
      label: "Legacy Hermes shared secret",
      placeholder: "secret compartido",
      help: "Alias legacy. Preferi SANCHO_EXTERNAL_SECRET para instalaciones nuevas.",
    },
    {
