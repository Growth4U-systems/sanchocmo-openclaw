...
3. **Links, nunca rutas** — SIEMPRE comparte docs como URL clickable: `https://staging.sanchocmo.ai/mc/docs/brand/{slug}/{pilar}/current.md`. NUNCA rutas como `brand/hospital-capilar/content-calendar.md`. El usuario no tiene acceso al filesystem. Cada vez que guardes un archivo y lo referencíes en Discord, conviértelo a URL de MC.
