...
| [prompts-phase6c.md](references/prompts-phase6c.md) | Phase 6c — JTBD clustering "Pain Cluster" (agente) |
...
## Phase 6: Agrupar en Personas + Pain Clusters
...
6c: Leer [prompts-phase6c.md](references/prompts-phase6c.md). Clustering JTBD ("Pain Cluster"). Agrupar personas en 5-10 grupos por dolor compartido. Cada grupo = nombre memorable + "Pain Cluster" statement + personas miembro con nombres descriptivos ("The X"). Output: `niches-raw/clusters.md`
...
Leer [prompts-phase10.md](references/prompts-phase10.md). Documento final unificado: Pain Clusters + Personas detalladas + Scoring + Recomendación. TODO en `current.md` — no crear documentos separados. Output: `current.md` + `final-table.csv`. Ver [schema.md](references/schema.md).
