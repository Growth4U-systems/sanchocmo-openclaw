...
- business-model/current.md (modelo de negocio, revenue streams)
- budget/current.md (márgenes, costes)
- company-context/current.md (contexto general)
...
```
Usando competitors/current.md como base, investiga los precios REALES de cada competidor.
...
```
Cruza positioning/current.md + swot-analysis/current.md con el pricing:
