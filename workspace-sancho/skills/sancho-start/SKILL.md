...
```
if brand/company-context.md exists AND is complete:
    mode = "RETURNING"
...
1. **Escribir `brand/company-context.md`** con los datos estructurados del onboarding
...
He guardado tu contexto en brand/company-context.md.
...
- `brand/company-context.md` (generado en Step 8)
