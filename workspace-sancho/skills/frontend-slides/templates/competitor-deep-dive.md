...
From `brand/{slug}/market-and-us/competitors/current.md` (roll-up) or `brand/{slug}/market-and-us/competitors/{nombre}/current.md` (deep-dive per competitor), extract:
...
2. Read `brand/{slug}/market-and-us/competitors/current.md` (roll-up) or glob `brand/{slug}/market-and-us/competitors/*/current.md` (per-competitor deep-dives) → extract data per competitor
