...
cat > "$BRAND_DIR/company-context/company-context.current.md" << 'PLACEHOLDER'
...
PLACEHOLDER
sed -i "s/{NOMBRE}/$NAME/g" "$BRAND_DIR/company-context/company-context.current.md"

cat > "$BRAND_DIR/business-model/business-model.current.md" << 'PLACEHOLDER'
<!-- mode: placeholder | status: not-started -->
...
PLACEHOLDER
sed -i "s/{NOMBRE}/$NAME/g" "$BRAND_DIR/business-model/business-model.current.md"

cat > "$BRAND_DIR/budget/budget.current.md" << 'PLACEHOLDER'
<!-- mode: placeholder | status: not-started -->
...
PLACEHOLDER
sed -i "s/{NOMBRE}/$NAME/g" "$BRAND_DIR/budget/budget.current.md"

cat > "$BRAND_DIR/company-brief/company-brief.current.md" << 'PLACEHOLDER'
...
PLACEHOLDER
sed -i "s/{NOMBRE}/$NAME/g" "$BRAND_DIR/company-brief/company-brief.current.md"

cat > "$BRAND_DIR/market-and-us/market/market.current.md" << 'PLACEHOLDER'
<!-- mode: placeholder | status: not-started -->
...
PLACEHOLDER
sed -i "s/{NOMBRE}/$NAME/g" "$BRAND_DIR/market-and-us/market/market.current.md"

cat > "$BRAND_DIR/market-and-us/self/self.current.md" << 'PLACEHOLDER'
<!-- mode: placeholder | status: not-started -->
...
PLACEHOLDER
sed -i "s/{NOMBRE}/$NAME/g" "$BRAND_DIR/market-and-us/self/self.current.md"

cat > "$BRAND_DIR/market-and-us/swot/swot.current.md" << 'PLACEHOLDER'
<!-- mode: placeholder | status: not-started -->
...
PLACEHOLDER
sed -i "s/{NOMBRE}/$NAME/g" "$BRAND_DIR/market-and-us/swot/swot.current.md"

cat > "$BRAND_DIR/market-and-us/summary/summary.current.md" << 'PLACEHOLDER'
<!-- mode: placeholder | status: not-started -->
...
PLACEHOLDER
sed -i "s/{NOMBRE}/$NAME/g" "$BRAND_DIR/market-and-us/summary/summary.current.md"

cat > "$BRAND_DIR/market-and-us/ope-canvas/ope-canvas.current.md" << 'PLACEHOLDER'
<!-- mode: placeholder | status: not-started -->
# OPE Canvas — {NOMBRE}
...
PLACEHOLDER
sed -i "s/{NOMBRE}/$NAME/g" "$BRAND_DIR/market-and-us/ope-canvas/ope-canvas.current.md"

cat > "$BRAND_DIR/go-to-market/ecps/ecps.current.md" << 'PLACEHOLDER'
<!-- mode: placeholder | status: not-started -->
...
PLACEHOLDER
sed -i "s/{NOMBRE}/$NAME/g" "$BRAND_DIR/go-to-market/ecps/ecps.current.md"
...
cat > "$BRAND_DIR/go-to-market/pricing/pricing.current.md" << 'PLACEHOLDER'
<!-- mode: placeholder | status: not-started -->
...
PLACEHOLDER
sed -i "s/{NOMBRE}/$NAME/g" "$BRAND_DIR/go-to-market/pricing/pricing.current.md"

cat > "$BRAND_DIR/brand-book/brand-voice/brand-voice.current.md" << 'PLACEHOLDER'
<!-- mode: placeholder | status: not-started -->
# Brand Voice — {NOMBRE}
...
PLACEHOLDER
sed -i "s/{NOMBRE}/$NAME/g" "$BRAND_DIR/brand-book/brand-voice/brand-voice.current.md"

cat > "$BRAND_DIR/brand-book/visual-identity/visual-identity.current.md" << 'PLACEHOLDER'
<!-- mode: placeholder | status: not-started -->
...
PLACEHOLDER
sed -i "s/{NOMBRE}/$NAME/g" "$BRAND_DIR/brand-book/visual-identity/visual-identity.current.md"

cat > "$BRAND_DIR/strategic-plan/strategic-plan.current.md" << 'PLACEHOLDER'
<!-- mode: placeholder | status: not-started -->
