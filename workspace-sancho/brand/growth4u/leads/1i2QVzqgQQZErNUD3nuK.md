---
ghl_id: 1i2QVzqgQQZErNUD3nuK
contact_name: Eduardo Zuñiga
...
- **Email**: eduardowon@gmail.com ✅
- **Phone**: No disponible
- **Company**: No identificada
- **Source**: Direct booking via calendar
- **Country**: ES (Europe/Madrid timezone)
- **Attribution**: Direct traffic → calendar booking

## Company Intelligence
**Empresa**: EIS Solutions (San Borja, probablemente Perú)  
**Servicios**: Staff Augmentation + Outsourcing + desarrollo de software a medida  
**Situación actual**:
- Website sin mantenimiento activo (desactualizada)
- Presencia LinkedIn bajo "EIS Solutions" (Eduardo no visible como perfil individual en página)
- Busca primeras validaciones de nicho y clientes
- Estrategia de adquisición inicial en desarrollo

**LinkedIn**: https://www.linkedin.com/company/eis-solutions (búsqueda: "EIS Solutions")

## Contact Enrichment
- Email verificado en GHL ✅
- Teléfono: No proporcionado en booking
...
**Pain Points identificados:**
- Website sin mantenimiento activo (hace tiempo sin actualizar)
- Necesita encontrar primeros clientes y validar nicho
- Comunicación digital débil (LinkedIn sin perfil personal visible en página empresa)
- Busca estrategia inicial de adquisición (no tiene canal activo)

**Next Steps acordados:**
- Reunión estratégica 17:30 Madrid (reagendada desde 17:15)
- Growth4U revisará web + LinkedIn antes de reunión
- Eduardo planteará preguntas sobre nicho y primeras intervenciones
- Evaluar encaje y cómo Growth4U puede ayudar

**Key Quotes:**
> "No tengo ninguna duda, espero más bien la reunión de mañana para tratar de plantear algunas preguntas"  
> "No sé si está activa, hace tiempo que no le damos mantenimiento" *(sobre su web)*  
> "La idea es ver si hay encaje, ¿no? Y si realmente te podríais llegar a ayudar y cómo"

**Observaciones:**
- Lead en fase muy early-stage (aún validando producto-mercado)
- Necesita quick wins: web actualizada, perfil LinkedIn optimizado, primeros 3-5 clientes
- Oportunidad: caso típico Staff Aug/Outsourcing → outreach directo LinkedIn + partnerships tech

## Sales Playbook
**Recomendaciones para reunión estratégica:**
1. Diagnóstico rápido: web + LinkedIn + propuesta de valor actual
2. Enfocar en **primeros 3 clientes** (no en escala): outreach manual LinkedIn + partners
3. Quick win #1: Actualizar web con casos de uso específicos (e.g. "Staff Aug para startups fintech en LATAM")
4. Quick win #2: Perfil LinkedIn personal Eduardo + posts semanales técnicos
