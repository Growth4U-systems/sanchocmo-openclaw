---
ghl_id: ZbyI3priwsibR0k7pwaB
contact_name: Luis Ayuso Elu
...
**Company**: INFONITE (infonite.tech)
**Sector**: Fintech / Open Banking Data Platform
**Product**: Plataforma de análisis de solvencia que combina datos de administración pública (GDaaS) con Open Banking. Integra motores con BBVA, CaixaBank, Santander, ING, Sabadell, Bankinter, AEAT, TGSS.
**Geografía**: España 🇪🇸 / Colombia 🇨🇴
**ICP fit**: B2B SaaS con producto data-heavy → necesita captación de clientes empresariales/bancos. Buen fit para Growth4U.

## Contact Enrichment

- **LinkedIn**: No encontrado — pendiente
- **Rol**: Desconocido (email luis@infonite.tech sugiere interno, posiblemente fundador/técnico)
